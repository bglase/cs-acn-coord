...
AcnCoordinator.prototype.setLed = function (flag) {
  this.sendCommand([0x01, 0x03, flag], 'cant set LED to HEX ' + flag);
};

AcnCoordinator.prototype.powerOff = function () {
  this.sendCommand([0x02, 0x02], 'controller wont poweroff');
};

AcnCoordinator.prototype.rumble = function (left, right) {
  ...
  this.sendCommand([0x00, 0x00, 0x04, left, right], 'controller wont rumble');
};
